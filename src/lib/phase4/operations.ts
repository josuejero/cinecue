...
import { listActiveLocationClusters } from "./location-clusters";
import { writeErrorLog, writeLog } from "./logging";
import { getPhase4NotificationQueue, getPhase4SyncQueue } from "./queues";
...
export async function getPhase4OperationalSnapshot() {
  const db = getDb();
